...
<div class="container">
  <h2>Add Explore </h2>
  <form class="form-horizontal" action="{{ route('storeExplore')}}" method="POST" enctype="multipart/form-data" >
        @csrf
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="pwd" placeholder="Enter password" name="from" value="{{ old('to') }}">
    </div>
    <div class="form-group">
